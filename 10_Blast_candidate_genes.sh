...
##########################################################################################################
#Blast whith NCBI data Protein Arthropoda present in the 3743 differntial gens expressed in Tetraripis
cd /home/tbessonn/Tetraripis_zetteli/tetraripis_zetteli_leg_transcriptome_novogene/9_Blast_identity/
...
blastx -db retrieved_sequence_Candidate_shrinkLFC_genes_3743_pvalue_0.01.fasta  -query retrieved_sequence_overexpressed_shrink_LFC_gene_926_ids.fasta -out blast_output_sequence_overexpressed_shrink_LFC_gene_926_ids.txt -outfmt "6" -evalue 1e-20 
...
# Retrieve the sequences 
blastdbcmd -db retrieved_sequence_Candidate_shrinkLFC_genes_3743_pvalue_0.01.fasta -dbtype nucl -entry_batch seqids_Protein_blast_output_sequence_overexpressed_shrink_LFC_gene_926_ids.txt -out retrieved_sequence_seqids_Protein_overexpressed_shrink_LFC_gene_926_ids.fasta
 
#####################################################################################
# Blast the sequences 2817 underexpressed genes
blastx -db retrieved_sequence_Candidate_shrinkLFC_genes_3743_pvalue_0.01.fasta  -query retrieved_sequence_underexpressed_shrink_LFC_gene_2817_ids.fasta -out blast_output_retrieved_sequence_underexpressed_shrink_LFC_gene_2817_ids.txt -outfmt "6" -evalue 1e-20 
...
# Retrieve the sequences 
blastdbcmd -db retrieved_sequence_Candidate_shrinkLFC_genes_3743_pvalue_0.01.fasta -dbtype nucl -entry_batch seqids_Protein_blast_output_sequence_underexpressed_shrink_LFC_gene_2817_ids.txt -out retrieved_sequence_seqids_Protein_seqids_Protein_underexpressed_shrink_LFC_gene_2817_ids.fasta
